#ifndef WJH_CHAT_E08BB677608263DB175A6591D533B89E572CFE1B
#define WJH_CHAT_E08BB677608263DB175A6591D533B89E572CFE1B
 ...
 * - kind: class
 * - type_namespace: wjh::chat::conversation
 * - type_name: Role
 * - description: std::string; <=>, non_empty
 * - default_value: ""
 */
class Role
: private atlas::strong_type_tag<Role>
{
    std::string value;
...
public:
    ...
    template <
        ...
        typename std::enable_if<
            ...
            bool>::type = true>
    constexpr explicit Role(ArgTs && ... args)
    : value(std::forward<ArgTs>(args)...)
    {
        if (not atlas::constraints::check<Role>(value)) {
            throw atlas::ConstraintError(
                "Role: " +
     ...
     */
    friend constexpr std::string const & atlas_value_for(Role const & self) noexcept {
        return self.value;
    }
    friend constexpr std::string & atlas_value_for(Role & self) noexcept {
        return self.value;
    }
    friend constexpr auto atlas_value_for(Role && self) noexcept
        -> typename std::enable_if<
...
#endif
inline constexpr wjh::chat::conversation::Role wjh::chat::conversation::Role::assistant = wjh::chat::conversation::Role("assistant");
inline constexpr wjh::chat::conversation::Role wjh::chat::conversation::Role::user = wjh::chat::conversation::Role("user");
#if defined(__clang__)
#pragma clang diagnostic pop
#endif
} // namespace conversation
...
#if __cplusplus < 202002L
template <>
struct std::hash<wjh::chat::conversation::Role>
: atlas::atlas_detail::hash_base<wjh::chat::conversation::Role>
{};
#endif
 ...
 * - kind: class
 * - type_namespace: wjh::chat::conversation
 * - type_name: StopReason
 * - description: std::string; <=>
 * - default_value: ""
 */
class StopReason
: private atlas::strong_type_tag<StopReason>
{
    std::string value;
...
public:
    ...
    static const StopReason stop_sequence;

    constexpr explicit StopReason() = default;
    ...
    template <
        ...
        typename std::enable_if<
            std::is_constructible<std::string, ArgTs...>::value,
            bool>::type = true>
    constexpr explicit StopReason(ArgTs && ... args)
    : value(std::forward<ArgTs>(args)...)
    { }
     ...
     * Access to immediate underlying value via ADL.
     */
    friend constexpr std::string const & atlas_value_for(StopReason const & self) noexcept {
        return self.value;
    }
    friend constexpr std::string & atlas_value_for(StopReason & self) noexcept {
        return self.value;
    }
    friend constexpr auto atlas_value_for(StopReason && self) noexcept
        -> typename std::enable_if<
            std::is_move_constructible<std::string>::value,
            std::string>::type
    {
     ...
     */
    friend constexpr bool operator < (
        StopReason const & lhs,
        StopReason const & rhs)
    noexcept(noexcept(std::declval<std::string const &>() <
        std::declval<std::string const &>()))
    {
        return lhs.value < rhs.value;
...
#pragma clang diagnostic ignored "-Wglobal-constructors"
#endif
inline constexpr wjh::chat::conversation::StopReason wjh::chat::conversation::StopReason::end_turn = wjh::chat::conversation::StopReason("end_turn");
inline constexpr wjh::chat::conversation::StopReason wjh::chat::conversation::StopReason::max_tokens = wjh::chat::conversation::StopReason("max_tokens");
inline constexpr wjh::chat::conversation::StopReason wjh::chat::conversation::StopReason::stop_sequence = wjh::chat::conversation::StopReason("stop_sequence");
#if defined(__clang__)
#pragma clang diagnostic pop
#endif
} // namespace conversation
...
#if __cplusplus < 202002L
template <>
struct std::hash<wjh::chat::conversation::StopReason>
: atlas::atlas_detail::hash_base<wjh::chat::conversation::StopReason>
{};
#endif
 ...
 * - kind: class
 * - type_namespace: wjh::chat::conversation
 * - type_name: MessageText
 * - description: std::string; <=>
 * - default_value: ""
 */
class MessageText
: private atlas::strong_type_tag<MessageText>
{
    std::string value;
...
public:
    ...
    constexpr explicit MessageText() = default;
    ...
    template <
        ...
        typename std::enable_if<
            std::is_constructible<std::string, ArgTs...>::value,
            bool>::type = true>
    constexpr explicit MessageText(ArgTs && ... args)
    : value(std::forward<ArgTs>(args)...)
    { }
     ...
     * Access to immediate underlying value via ADL.
     */
    friend constexpr std::string const & atlas_value_for(MessageText const & self) noexcept {
        return self.value;
    }
    friend constexpr std::string & atlas_value_for(MessageText & self) noexcept {
        return self.value;
    }
    friend constexpr auto atlas_value_for(MessageText && self) noexcept
        -> typename std::enable_if<
            std::is_move_constructible<std::string>::value,
            std::string>::type
    {
     ...
     */
    friend constexpr bool operator < (
        MessageText const & lhs,
        MessageText const & rhs)
    noexcept(noexcept(std::declval<std::string const &>() <
        std::declval<std::string const &>()))
    {
        return lhs.value < rhs.value;
...
#if __cplusplus < 202002L
template <>
struct std::hash<wjh::chat::conversation::MessageText>
: atlas::atlas_detail::hash_base<wjh::chat::conversation::MessageText>
{};
#endif
#endif // WJH_CHAT_E08BB677608263DB175A6591D533B89E572CFE1B
