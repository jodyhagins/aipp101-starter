#ifndef WJH_CHAT_AF62822BFDB45A91FADEE8DD746D4AAA2A939C4C
#define WJH_CHAT_AF62822BFDB45A91FADEE8DD746D4AAA2A939C4C
 ...
 * - kind: class
 * - type_namespace: wjh::chat::client
...
public:
     ...
     */
    friend constexpr int const & atlas_value_for(HttpStatusCode const & self) noexcept {
        return self.value;
    }
    friend constexpr int & atlas_value_for(HttpStatusCode & self) noexcept {
        return self.value;
    }
    ...
    template <
        ...
        typename = atlas::atlas_detail::enable_if_t<
            atlas::borrow_policy<BorrowTargetT, int>::value>>
...
#if __cplusplus < 202002L
template <>
struct std::hash<wjh::chat::client::HttpStatusCode>
: atlas::atlas_detail::hash_base<wjh::chat::client::HttpStatusCode>
{};
#endif
 ...
 */
class Hostname
: private atlas::strong_type_tag<Hostname>
{
    std::string value;
...
public:
    ...
    template <
        ...
        typename std::enable_if<
            ...
            bool>::type = true>
    constexpr explicit Hostname(ArgTs && ... args)
    : value(std::forward<ArgTs>(args)...)
    {
        if (not atlas::constraints::check<Hostname>(value)) {
            throw atlas::ConstraintError(
                "Hostname: " +
     ...
     * Access to immediate underlying value via ADL.
     */
    friend constexpr std::string const & atlas_value_for(Hostname const & self) noexcept {
        return self.value;
    }
    friend constexpr std::string & atlas_value_for(Hostname & self) noexcept {
        return self.value;
    }
    friend constexpr auto atlas_value_for(Hostname && self) noexcept
        -> typename std::enable_if<
...
#if __cplusplus < 202002L
template <>
struct std::hash<wjh::chat::client::Hostname>
: atlas::atlas_detail::hash_base<wjh::chat::client::Hostname>
{};
#endif
 ...
 */
class PortNumber
: private atlas::strong_type_tag<PortNumber>
{
    int value = static_cast<int>(443);

public:
    using atlas_value_type = int;
    using atlas_constraint = atlas::constraints::positive<int>;

    constexpr explicit PortNumber() = default;
    ...
    template <
        ...
        typename std::enable_if<
            std::is_constructible<int, ArgTs...>::value,
            bool>::type = true>
    constexpr explicit PortNumber(ArgTs && ... args)
    : value(std::forward<ArgTs>(args)...)
    {
        if (not atlas::constraints::check<PortNumber>(value)) {
            throw atlas::ConstraintError(
                "PortNumber: " +
                atlas::constraints::detail::format_value(value) +
     ...
     * Access to immediate underlying value via ADL.
     */
    friend constexpr int const & atlas_value_for(PortNumber const & self) noexcept {
        return self.value;
    }
    friend constexpr int & atlas_value_for(PortNumber & self) noexcept {
        return self.value;
    }
    friend constexpr auto atlas_value_for(PortNumber && self) noexcept
        -> typename std::enable_if<
            std::is_move_constructible<int>::value,
            int>::type
    {
     ...
     */
    friend constexpr bool operator < (
        PortNumber const & lhs,
        PortNumber const & rhs)
    noexcept(noexcept(std::declval<int const &>() <
        std::declval<int const &>()))
    {
        return lhs.value < rhs.value;
...
#if __cplusplus < 202002L
template <>
struct std::hash<wjh::chat::client::PortNumber>
: atlas::atlas_detail::hash_base<wjh::chat::client::PortNumber>
{};
#endif
 ...
 */
class HttpPath
: private atlas::strong_type_tag<HttpPath>
{
    std::string value;
...
public:
    ...
    template <
        ...
        typename std::enable_if<
            std::is_constructible<std::string, ArgTs...>::value,
            bool>::type = true>
    constexpr explicit HttpPath(ArgTs && ... args)
    : value(std::forward<ArgTs>(args)...)
    {
        if (not atlas::constraints::check<HttpPath>(value)) {
            throw atlas::ConstraintError(
                "HttpPath: " +
                atlas::constraints::detail::format_value(value) +
                " violates constraint: value must not be empty");
     ...
     * Access to immediate underlying value via ADL.
     */
    friend constexpr std::string const & atlas_value_for(HttpPath const & self) noexcept {
        return self.value;
    }
    friend constexpr std::string & atlas_value_for(HttpPath & self) noexcept {
        return self.value;
    }
    friend constexpr auto atlas_value_for(HttpPath && self) noexcept
        -> typename std::enable_if<
            std::is_move_constructible<std::string>::value,
            std::string>::type
    {
...
#if __cplusplus < 202002L
template <>
struct std::hash<wjh::chat::client::HttpPath>
: atlas::atlas_detail::hash_base<wjh::chat::client::HttpPath>
{};
#endif
 ...
 */
class HttpBody
: private atlas::strong_type_tag<HttpBody>
{
    std::string value;
...
public:
    ...
    constexpr explicit HttpBody() = default;
    ...
    template <
        ...
        typename std::enable_if<
            std::is_constructible<std::string, ArgTs...>::value,
            bool>::type = true>
    constexpr explicit HttpBody(ArgTs && ... args)
    : value(std::forward<ArgTs>(args)...)
    { }
     ...
     * Access to immediate underlying value via ADL.
     */
    friend constexpr std::string const & atlas_value_for(HttpBody const & self) noexcept {
        return self.value;
    }
    friend constexpr std::string & atlas_value_for(HttpBody & self) noexcept {
        return self.value;
    }
    friend constexpr auto atlas_value_for(HttpBody && self) noexcept
        -> typename std::enable_if<
            std::is_move_constructible<std::string>::value,
            std::string>::type
    {
...
#if __cplusplus < 202002L
template <>
struct std::hash<wjh::chat::client::HttpBody>
: atlas::atlas_detail::hash_base<wjh::chat::client::HttpBody>
{};
#endif
 ...
 * - kind: class
 * - type_namespace: wjh::chat::client
 * - type_name: HeaderName
 * - description: std::string; <=>, non_empty
 * - default_value: ""
 */
class HeaderName
: private atlas::strong_type_tag<HeaderName>
{
    std::string value;
...
public:
    ...
    template <
        ...
        typename std::enable_if<
            std::is_constructible<std::string, ArgTs...>::value,
            bool>::type = true>
    constexpr explicit HeaderName(ArgTs && ... args)
    : value(std::forward<ArgTs>(args)...)
    {
        if (not atlas::constraints::check<HeaderName>(value)) {
            throw atlas::ConstraintError(
                "HeaderName: " +
                atlas::constraints::detail::format_value(value) +
                " violates constraint: value must not be empty");
     ...
     * Access to immediate underlying value via ADL.
     */
    friend constexpr std::string const & atlas_value_for(HeaderName const & self) noexcept {
        return self.value;
    }
    friend constexpr std::string & atlas_value_for(HeaderName & self) noexcept {
        return self.value;
    }
    friend constexpr auto atlas_value_for(HeaderName && self) noexcept
        -> typename std::enable_if<
            std::is_move_constructible<std::string>::value,
            std::string>::type
    {
     ...
     */
    friend constexpr bool operator < (
        HeaderName const & lhs,
        HeaderName const & rhs)
    noexcept(noexcept(std::declval<std::string const &>() <
        std::declval<std::string const &>()))
    {
        return lhs.value < rhs.value;
...
#if __cplusplus < 202002L
template <>
struct std::hash<wjh::chat::client::HeaderName>
: atlas::atlas_detail::hash_base<wjh::chat::client::HeaderName>
{};
#endif
 ...
 */
class HeaderValue
: private atlas::strong_type_tag<HeaderValue>
{
    std::string value;
...
public:
    ...
    constexpr explicit HeaderValue() = default;
    ...
    template <
        ...
        typename std::enable_if<
            std::is_constructible<std::string, ArgTs...>::value,
            bool>::type = true>
    constexpr explicit HeaderValue(ArgTs && ... args)
    : value(std::forward<ArgTs>(args)...)
    { }
     ...
     * Access to immediate underlying value via ADL.
     */
    friend constexpr std::string const & atlas_value_for(HeaderValue const & self) noexcept {
        return self.value;
    }
    friend constexpr std::string & atlas_value_for(HeaderValue & self) noexcept {
        return self.value;
    }
    friend constexpr auto atlas_value_for(HeaderValue && self) noexcept
        -> typename std::enable_if<
            std::is_move_constructible<std::string>::value,
            std::string>::type
    {
     ...
     */
    friend constexpr bool operator < (
        HeaderValue const & lhs,
        HeaderValue const & rhs)
    noexcept(noexcept(std::declval<std::string const &>() <
        std::declval<std::string const &>()))
    {
        return lhs.value < rhs.value;
...
#if __cplusplus < 202002L
template <>
struct std::hash<wjh::chat::client::HeaderValue>
: atlas::atlas_detail::hash_base<wjh::chat::client::HeaderValue>
{};
#endif
 ...
 */
class FinishReason
: private atlas::strong_type_tag<FinishReason>
{
    std::string value;
...
public:
    ...
    constexpr explicit FinishReason() = default;
    ...
    template <
        ...
        typename std::enable_if<
            std::is_constructible<std::string, ArgTs...>::value,
            bool>::type = true>
    constexpr explicit FinishReason(ArgTs && ... args)
    : value(std::forward<ArgTs>(args)...)
    { }
     ...
     * Access to immediate underlying value via ADL.
     */
    friend constexpr std::string const & atlas_value_for(FinishReason const & self) noexcept {
        return self.value;
    }
    friend constexpr std::string & atlas_value_for(FinishReason & self) noexcept {
        return self.value;
    }
    friend constexpr auto atlas_value_for(FinishReason && self) noexcept
        -> typename std::enable_if<
            std::is_move_constructible<std::string>::value,
            std::string>::type
    {
     ...
     */
    friend constexpr bool operator < (
        FinishReason const & lhs,
        FinishReason const & rhs)
    noexcept(noexcept(std::declval<std::string const &>() <
        std::declval<std::string const &>()))
    {
        return lhs.value < rhs.value;
...
#if __cplusplus < 202002L
template <>
struct std::hash<wjh::chat::client::FinishReason>
: atlas::atlas_detail::hash_base<wjh::chat::client::FinishReason>
{};
#endif
...
public:
     ...
     * Access to immediate underlying value via ADL.
     */
    friend constexpr int const & atlas_value_for(TimeoutSeconds const & self) noexcept {
        return self.value;
    }
    friend constexpr int & atlas_value_for(TimeoutSeconds & self) noexcept {
        return self.value;
    }
...
#if __cplusplus < 202002L
template <>
struct std::hash<wjh::chat::client::TimeoutSeconds>
: atlas::atlas_detail::hash_base<wjh::chat::client::TimeoutSeconds>
{};
#endif
#endif // WJH_CHAT_AF62822BFDB45A91FADEE8DD746D4AAA2A939C4C
